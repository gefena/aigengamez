      ...
      <div className={styles.container}>
        ...
        <div className={styles.linksSection}>
          <div className={styles.linkGroup}>
            ...
            <Link href="/explore" className={styles.link}>Categories</Link>
            <Link href="/explore" className={styles.link}>New Releases</Link>
          </div>
          <div className={styles.linkGroup}>
            <h4 className={styles.linkGroupTitle}>Company</h4>
            <Link href="/about" className={styles.link}>About Us</Link>
            <a href="mailto:hello@aigengamez.com" className={styles.link}>Contact</a>
